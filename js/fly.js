...
$(document).ready(function() {
	...
	// alert(value);
		switch (value) { 
		case 1: 
			var fly = new Fly("test", "Nhặng", "Đen", height_fly, width_fly, 0, 0, "img/fly/flies.png", "Long ruồi");	
			break;
		case 2: 
			var fly = new Fly("test", "Nhặng", "Xanh", height_fly, width_fly, 0, 0, "img/fly/style_1.png", "King ruồi");
			break;
		case 3: 
			var fly = new Fly("test", "Nhặng", "Tuyệt sắc", height_fly, width_fly, 0, 0, "img/fly/style_2.png","Tom ruồi");
			break;		
		case 4: 
			var fly = new Fly("test", "Nhặng", "Hồng", height_fly, width_fly, 0, 0, "img/fly/style_3.png", "Queen ruồi");
			break;
		}
		fly.move();	

	if(var_2 == 'true'){
		var fly2 = new Fly("test", "Nhặng", "Xanh", height_fly, width_fly, 0, 0, "img/fly/style_1.png", "King ruồi");
		// var fly3 = new Fly("test", "Nhặng", "Tuyệt sắc", 0, 0, 0, 0, "img/fly/style_2.png","Tom ruồi");
		// var fly4 = new Fly("test", "Nhặng", "Hồng", 0, 0, 0, 0, "img/fly/style_3.png", "Queen ruồi");
		fly2.move();
		fly2.flying();
		// fly3.move();
		// fly4.move();
